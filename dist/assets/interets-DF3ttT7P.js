import{V as d,C as J,W as B,P as D,T as _,S as I,a as V,A as O,b as U,R as X,e as Y,F as R,f as E,M as q,g as l,h,i as f,j as x,t as T,u as v,D as k,r as K,o as N,s as Q,p as Z}from"./TextGeometry-CdrQ54mS.js";let m,r,p,b,G,M,g=16770032,P=6037302,$=6375504,w,y,S,H=[];const ee=[new d(-160,-90,10),new d(-40,20,10),new d(-30,-100,10),new d(120,-170,10),new d(150,60,10),new d(250,-20,10)],W=new J(ee),F=W.computeFrenetFrames(100,!0);ce();function j(n,t,o){const e=-n/2,s=-t/2,a=new Z;return a.moveTo(e+o,s),a.lineTo(e+n-o,s),a.quadraticCurveTo(e+n,s,e+n,s+o),a.lineTo(e+n,s+t-o),a.quadraticCurveTo(e+n,s+t,e+n-o,s+t),a.lineTo(e+o,s+t),a.quadraticCurveTo(e,s+t,e,s+t-o),a.lineTo(e,s+o),a.quadraticCurveTo(e,s,e+o,s),a}function C(n,t,o,e,s,a,c){new R().load("fonts/optimer_regular.typeface.json",function(u){const L=new E(n,{font:u,size:t,depth:o,height:e,curveSegments:s});L.center();const z=new q({color:a});w=new l(L,z),w.position.set(c.x,c.y,c.z),r.add(w)},function(u){console.log(u.loaded/u.total*100+"% loaded")},function(u){console.log("An error happened")})}function ne(){new R().load("fonts/optimer_bold.typeface.json",function(t){const o=new E("Intérêts",{font:t,size:20,depth:2,height:0,curveSegments:8});o.center();const e=new q({color:g});w=new l(o,e),w.position.set(0,100,10),r.add(w)},function(t){console.log(t.loaded/t.total*100+"% loaded")},function(t){console.log("An error happened")})}function te(){const n=new h().load("textures/pictures/cv_picture_house.jpg"),t=new f(30,32),o=new x({map:n,transparent:!1});y=new l(t,o),y.position.set(-320,130,10),r.add(y);const e=new f(32,32),s=new q({color:g});S=new l(e,s),S.position.set(-320,130,9.9),r.add(S)}function oe(){const n=j(200,180,10),t=new T(n),o=new v({color:P,side:k}),e=new l(t,o);e.position.set(-250,-60,9.9),r.add(e);const s=new h().load("textures/pictures/hobbies/music.JPG"),a=new f(30,32),c=new x({map:s,transparent:!1}),i=new l(a,c);i.position.set(-300,40,10),r.add(i),C(`La majorité de mon temps libre 
...
deviné) la musique 
hispanophone !`,7,1,0,8,g,new d(250,-60,10))}function ie(){const n=new h().load("textures/sprites/sparkle.png"),t=new K({map:n,color:9408399,transparent:!0,blending:N,depthWrite:!1});for(let o=0;o<2e3;o++){const e=new Q(t.clone());e.scale.set(1,1,1),r.add(e),H.push({sprite:e,offset:Math.random()})}}function ce(){p=new B({antialias:!0}),p.setPixelRatio(window.devicePixelRatio),p.setSize(window.innerWidth,window.innerHeight),p.setAnimationLoop(A),document.body.appendChild(p.domElement),m=new D(45,window.innerWidth/window.innerHeight,1,1e3),m.position.set(0,0,500),b=new _(m,p.domElement),b.minDistance=200,b.maxDistance=500,r=new I,r.background=new V($),r.add(new O(6710886));const n=new U(16777215,3,0,0);n.position.copy(m.position),r.add(n),ne(),te(),oe(),se(),ae(),re(),ie(),G=new X,M=new Y,window.addEventListener("click",le)}function le(n){M.x=n.clientX/window.innerWidth*2-1,M.y=-(n.clientY/window.innerHeight)*2+1,G.setFromCamera(M,m),G.intersectObjects([y]).length>0&&(window.location.href="index.html")}function de(n){H.forEach(t=>{const o=(n*.05+t.offset)%1,e=W.getPointAt(o),s=Math.floor(o*F.tangents.length),a=F.normals[s],c=F.binormals[s],i=a.clone().add(c.clone());t.sprite.position.copy(e.clone().add(i)),t.sprite.position.add(new d((Math.random()-.5)*2,(Math.random()-.5)*2,(Math.random()-.5)*2))})}function A(){requestAnimationFrame(A),b.update();const n=performance.now();de(n*.005),p.render(r,m)}p.setAnimationLoop(A);
